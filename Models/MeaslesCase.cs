...
        //[Phone]
        public double HealthcareCentreTelephone { get; set; }
...
        public double PatientTelephoneNumber { get; set; }
        ...
        [Required]
        [Display(Name = "Patient presented with any symptoms related to Measles: Yes, No, Unk")]
        [StringLength(255)]
        public string PatientSymptomsPositiveForMeasles { get; set; } //Yes, No, Unk
...
        //Pics
        public byte[]? PatientMeaslesPicture { get; set; }
