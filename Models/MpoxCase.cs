...
        public double PatientTelephoneNumber { get; set; }
        ...
        [Required]
        [Display(Name = "Patient presented with any symptoms related to mpox: Yes, No, Unk")]
        [StringLength(255)]
        public string PatientSymptomsPositiveForMpox { get; set; } //Yes, No, Unk
